...
import com.example.nimons360.databinding.ItemMyFamilyBinding

class MyFamilyAdapter(
    private val families: List<MyFamilyDetail>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemMyFamilyBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val memberCount = item.members?.size ?: 0
        b.tvMemberCount.text = "$memberCount members"
